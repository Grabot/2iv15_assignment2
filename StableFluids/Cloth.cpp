...
void Cloth::draw(bool show)
{
	...
	if (show)
	{
		//glVertex2f(m_Corners[0]->m_Position[0], m_Corners[0]->m_Position[1]);
		//glVertex2f(m_Corners[1]->m_Position[0], m_Corners[1]->m_Position[1]);
		//glVertex2f(m_Corners[2]->m_Position[0], m_Corners[2]->m_Position[1]);
		//glVertex2f(m_Corners[3]->m_Position[0], m_Corners[3]->m_Position[1]);
	}
	glEnd();
}
